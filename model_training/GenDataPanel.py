...
class GenDataPanel(wx.Panel):
    ...
    def __init__(self, parent, order_path=None):
        ...
        self.text_file_name.AppendText('训练样本1')
        ...
        self.text_file_path.AppendText('C:\\Users\\wxq\\Desktop\\ScheduleSystem-main\\orders\\training')
        ''' 选择路径按钮 '''
        ...
        ''' 生成订单按钮 '''
        btn_generating = wx.Button(file_panel, wx.ID_ANY, u"生成样本",
        ...
        file_sizer.Add(btn_generating, 1, wx.ALL, 5)
